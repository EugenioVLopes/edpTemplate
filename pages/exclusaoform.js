    ...
    <Base>
      ...
      <div className="py-12">
        <div className="container rounded border border-border p-6 dark:border-darkmode-border">
          ...
          <div className="mt-3 flex">
            <div className="flex-1">
              <label htmlFor="nomeCompletoTitularLegal">Nome completo *:</label>
              <input
                type="text"
          ...
          <h3 className="mt-3">3. Selecione o direito que pretende exercer:</h3>
          <div className="mt-3">
            <input
              type="checkbox"
              id="servico"
            ...
            <label htmlFor="servicoEliminarDados">
              Eliminação dos dados pessoais tratados com o consentimento, exceto
          ...
          <h3 className="mt-3">5. Documentos de comprovação de identidade *</h3>
          <h5 className="mt-3">
            Junte algum documento que comprove a identificação do titular dos
            dados e do responsável (quando aplicável). Os formatos aceitos são:
            pdf, jpg, jpeg e png.
          </h5>
          <div className="mt-3">
