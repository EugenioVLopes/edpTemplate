              ...
              <div className="form-container">
                ...
                <div>
                  <h5 className="h5">
                    ...
                    Tribunal Regional do Trabalho da 21ª Região, possui o
                    direito de tratar os dados pessoais sensíveis, sem a
                    necessidade de fornecimento de consentimento de seu titular,
                    pois está respaldado em função de sua atividade fim,
                    legitimada no exercício regular de direitos, entre estes o
                    contrato e o processo judicial, administrativo e arbitral.
                    Também, o Tribunal, na mesma condição, poderá tratar dados
                    pessoais sensíveis, quando se tratar de obrigação legal ou
                    regulatória de seu controlador; nos casos de proteção da
                    vida ou da incolumidade física do titular ou de terceiros;
                    quando for para garantir e prevenir fraude e a segurança do
                    titular; nos processos de identificação e autenticação de
                    cadastro em sistemas eletrônicos; entre outros casos
                    previstos na Lei.
                  </h5>
                </div>
                ...
                <label htmlFor="nomeSocialTitularLegal">
                  <br />
                  Nome Social{" "}
                </label>
                <input
                ...
                />
                <h3>3. Selecione o direito que pretende exercer:</h3>
                ...
                <div>
                  ...
                  <select id="cidade" name="cidade">
                    ...
                    <option value="Jardim de Piranhas">
                      Jardim de Piranhas
                    </option>
                    ...
                    <option value="São Bento do Norte">
                      São Bento do Norte
                    </option>
                    ...
                    <option value="São João do Sabugi">
                      São João do Sabugi
                    </option>
                    <option value="São José de Mipibu">
                      São José de Mipibu
                    </option>
                    <option value="São José do Campestre">
                      São José do Campestre
                    </option>
                    <option value="São José do Seridó">
                      São José do Seridó
                    </option>
                    ...
                    <option value="Serra de São Bento">
                      Serra de São Bento
                    </option>
                ...
                <h3>5. Documentos de comprovação de identidade *</h3>
                <h5>
                  Junte algum documento que comprove a identificação do titular
                  dos dados e do responsável (quando aplicável). Os formatos
                  aceitos são: pdf, jpg, jpeg e png.
                </h5>
